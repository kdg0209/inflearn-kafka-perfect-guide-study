 ...
 * kafka-console-consumer --bootstrap-server localhost:9092 --group group-01 --topic multipart-topic --property print.key=true --property print.value=true --property print.partition=true --key-deserializer "org.apache.kafka.common.serialization.IntegerDeserializer"
 */
