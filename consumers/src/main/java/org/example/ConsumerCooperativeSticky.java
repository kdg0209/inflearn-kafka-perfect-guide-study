 ...
 * kafka-consumer-groups --bootstrap-server localhost:9092 --describe --group group-cooperative-sticky-topic
 */

public class ConsumerCooperativeSticky {

    public static final Logger LOGGER = LoggerFactory.getLogger(ConsumerCooperativeSticky.class.getName());

    private static final String BOOTSTRAP_SERVERS_CONFIG = "localhost:9092";
    private static final String GROUP_NAME = "group-cooperative-sticky-topic";
