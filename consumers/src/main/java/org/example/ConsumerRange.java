 ...
 * kafka-consumer-groups --bootstrap-server localhost:9092 --describe --group group-range-topic
 */

public class ConsumerRange {

    public static final Logger LOGGER = LoggerFactory.getLogger(ConsumerRange.class.getName());

    private static final String BOOTSTRAP_SERVERS_CONFIG = "localhost:9092";
    private static final String GROUP_NAME = "group-range-topic";
